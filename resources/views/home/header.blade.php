      ...
      <div class="header-desk header-desk_type_1">
        ...
        <nav class="navigation">
          <ul class="navigation__list list-unstyled d-flex">
            ...
            <li class="navigation__item">
              <a href="{{url('cart')}}" class="navigation__link">Cart</a>
            </li>
            <li class="navigation__item">
            ...
            <li class="navigation__item">
              <a href="{{route('user.orders')}}" class="navigation__link">MY ORDER</a>
            </li>
          </ul>
        </nav>
        ...
        <div class="header-tools d-flex align-items-center">
          ...
          @if (Route::has('login'))
                    ...
                    @else                        
                        ...
                        @if (Route::has('register'))
                         ...
                         <div class="header-tools__item hover-container">
                      <a href="{{url('register')}}" class="header-tools__item">
                    <svg class="d-block" width="20" height="20" viewBox="0 0 20 20" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <use href="#icon_user" />
              </svg>
          ...
          <a href="{{ route('wishlist.index') }}" class="header-tools__item header-tools__cart position-relative">
        ...
        @endif
          ...
          <a href="{{ url('cart') }}" class="header-tools__item header-tools__cart">
    <svg class="d-block" width="20" height="20" viewBox="0 0 20 20" fill="none"
         xmlns="http://www.w3.org/2000/svg">
        <use href="#icon_cart" />
    </svg>
