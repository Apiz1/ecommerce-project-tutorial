                                        ...
                                        <fieldset>
                                            ...
                                            <div class="upload-image mb-16">
                                                ...
                                                @foreach(explode(',',$product->images) as $img)
                                                 ...
                                                 <img src="/product_gallery/{{trim($img)}}" alt="">
                                                     </div>
                                                     @endforeach
                                                     @endif                                        
                                             ...
                                             <div id="galpreview" class="upload-image mb-16" style="display:none; flex-wrap: wrap;">
   ...
   <script>
    $(function () {
        ...
        $("#gFile").on("change", function () {
            ...
            const $galPreview = $("#galpreview"); // Make sure this exists in your HTML
            $galPreview.empty().show();

            $.each(gphotos, function (key, val) {
                const imgTag = `<div class="item gitems">
                                    <img src="${URL.createObjectURL(val)}" class="effect8"
                                         style="width:100px; margin:5px; border-radius:4px;" />
                                </div>`;
                $galPreview.append(imgTag);
            });
        });
